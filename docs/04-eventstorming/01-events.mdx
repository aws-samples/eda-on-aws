...
Is a user scrolling the to bottom of a webpage a domain event? If you are operating in the domain of
e-commerce, it's unlikely you may care about this. However, if you're building a web analytics
platform, a user scrolling to the bottom of the page may be very important. It's up to you and the
other domain experts to define what is or is not a domain event.

Add a time constraint when starting the workshop and creating events. 10 or 15 minutes will usually
suffice to get started. When doing a Big Picture session more time isn't better because people may
feel the need to go into details. Remember that a Big Picture session is just...big picture! It can
